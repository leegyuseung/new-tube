...
import { THUMNAIL_FALLBACK } from "@/modules/videos/constants";
              ...
              <FormField
                ...
                render={() => (
                  <FormItem>
                    ...
                    <FormControl>
                      <div className="p-0.5 border border-dashed border-x-neutral-400 relative h-[84px] w-[153px] group">
                        <Image
                          fill
                          alt="thumbnail"
                        ...
                        <DropdownMenu>
                          <DropdownMenuTrigger asChild>
                            ...
                            >
                              <MoreVerticalIcon className="size-4 text-wrap" />
                            </Button>
                          </DropdownMenuTrigger>
                    ...
                    <div className="flex flex-col gap-y-1">
                      ...
                      <div className="flex items-center gap-x-2">
                        <Link href={`/videos/${video.id}`}>
                          <p className="line-clamp-1 text-start text-blue-500">
                            {fullUrl}
                          </p>
                        </Link>
                        <Button
